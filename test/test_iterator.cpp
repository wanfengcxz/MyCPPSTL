...
void test_is_bidirectional_iterator() {
    std::cout << std::boolalpha;

    std::cout << stl::is_random_access_iterator<C>::value << std::endl;
    std::cout << stl::is_forward_iterator<C>::value << std::endl;
    std::cout << stl::is_bidirectional_iterator<C>::value << std::endl;
