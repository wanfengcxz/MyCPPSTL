...
#ifndef MYCPPSTL_MEMORY_H
#define MYCPPSTL_MEMORY_H
...
namespace stl {
    ...
    private:
        ...
        // 如果没有默认构造函数，则需要一个一个填充
        void initialize_buffer(const T &value, std::false_type) {
            stl::uninitialized_fill_n(buffer, len, value);
        }
    ...
    public:
        ...
        // 一般都加入const 因为这样以来const和非const都能够传进来
